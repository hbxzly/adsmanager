...
public class CookieUtil {
     ...
     * @return
     */
    public static long natureTime(Date date){
        ...
        return ((between - HOUR) / HOUR + 1);
    }


    public static long checkCookie(AccountCookie accountCookie){

        Date updateTime = accountCookie.getUpdateTime();
        return natureTime(updateTime);
